...
3. vi pod (gem install defualt path is /usr/bin/pod)
...
5. cd path_to_you_podfile && pod -v 0.39.0 install --no-repo-update
...
4. bundle install && bundle exec pod install --no-repo-update
